...
@Component({
  ...
  template: `
    <!-- 
      FIXED: Used 'fixed inset-0' to force full-screen coverage, ignoring parent layout constraints.
      Added 'overflow-y-auto' for scrollability on small screens.
    -->
    <div class="fixed inset-0 z-50 overflow-y-auto gradient-bg flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <!-- Login Container -->
      <div class="relative z-10 w-full max-w-md lg:max-w-lg animate-fade-in-up my-auto">
              ...
              <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <svg class="w-5 h-5 text-indigo-200 group-focus-within:text-white transition-colors" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 4 4 4 0 00-8zm0 0v1.5M12 15.5a3 3 0 100-6 3 3 0 000 6z"/>
                  </svg>
                </div>
                <input 
                  id="email" 
        ...
        <!-- Quick Access (Demo Only - Hidden on small mobile screens to save space) -->
